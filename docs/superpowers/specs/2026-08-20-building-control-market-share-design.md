...
- Official company/product names, start/original end/extension/effective end, status, nullable unverified termination provenance, exact target classifications, list/detail identities, raw JSON, and sync provenance. Cancellation/revocation fields stay null until a future live contract proves them and are not a current classification condition.
